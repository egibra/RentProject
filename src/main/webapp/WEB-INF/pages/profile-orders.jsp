...
<customtags:userProfileTemplate>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            <h2><spring:eval expression="@environment.getProperty('profile.orders.header')"/></h2>
            <p>
                <spring:eval expression="@environment.getProperty('profile.orders.body')"/>
            </p>
        </div>
        ...
        <table class="table table-condensed orders-table">
            ...
            <c:forEach var="order" items="${orders}" varStatus="loop">
                <tr data-toggle="collapse" data-target="#table-item-${order.nr}" class="accordion-toggle table-row">
                    ...
                    <td><c:out value="${order.state.name}"/></td>
                </tr>
                <tr><td colspan="4" class="hidden-row">
