    ...
    <div class="container text-center">
        ...
        <c:if test="${param.success != null }">
            <div class="alert alert-success alert-dismissible" style="margin-top: 20px" role="alert">
                ...
                <strong>Patvirtinimo laiškas išsiūstas sėkmingai.</strong>
            </div>
        </c:if>

        <h1 class="glyphicon glyphicon-remove text-danger"></h1>
        <h1>Registracija nepatvirtina</h1>
        <p><b>Klaida: </b><c:out value="${message}"/></p>
        <br/>

        <p>Spauskite <a data-toggle="modal" data-target="#resend-modal" role="button">čia</a>, jei norite, jog būtų
            persiūstas
            aktyvacijos laiškas.</p>
